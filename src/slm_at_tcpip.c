...
static int handle_at_led(enum at_cmd_type cmd_type);
...
static slm_at_cmd_list_t m_tcpip_at_list[AT_TCPIP_MAX] = {
	...
	{AT_PSM, "AT#XPSM", handle_at_psm},
	{AT_LED, "AT#XLED", handle_at_led},
	{AT_BAHE, "AT#XBAHE", handle_at_bahe},
};
...
/**@brief handle AT#XBAHE commands
 *  AT#XBAHE=<onoff>
 *  AT#XBAHE?
...
/**@brief handle AT#XLED commands
 *  AT#XLED=<onoff>
 *  AT#XLED?
 *  AT#XLED=? TEST command not supported
 */
static int handle_at_led(enum at_cmd_type cmd_type)
{
